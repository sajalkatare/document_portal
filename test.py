...
# #     act_path = Path("G:\\python_proj\\document_portal\\data\\document_compare\\Long_Report_V2.pdf")sh ko ca
...
## Multi-document chat testing code
...
#             "data\\multi_doc_chat\\sample-2.pdf",
